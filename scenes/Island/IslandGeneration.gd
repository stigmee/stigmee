...
# ==============================================================================
func _build_island():
	if $GeneratedIsland.mesh == null:
		_generate_island()
	pass

# ==============================================================================
# Generate meshes of an island and store them inside GeneratedIsland.
# ==============================================================================
func _generate_island():
	...
	for i in range(data_tool.get_vertex_count()):
		...
		vertex.y = (noiseValue - _gradient_at_position(vertex)) * MAP_INTENSITY
...
#
# ==============================================================================
func _gradient_at_position(pos):
